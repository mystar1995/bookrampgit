			...
			<div class="col-lg-4">
				<div class="page-header-breadcrumb">
					<ul class=" breadcrumb breadcrumb-title">
						...
						<li class="breadcrumb-item"><a href="#!">CONTENT - PUBLISHED</a></li>
					</ul>
				</div>
			</div>
		</div>
						...
						<div class="card-header">
							<div class="row">
								<div class="col-md-12">
									...
									<a href="javascript:;" class="btn btn-success btn-round disabled action_btn active" attr_status="UNDERREVIEW">UnderReview Books</a>
									<a href="javascript:;" class="btn btn-round btn-danger disabled action_btn active" attr_status="REJECTED">Reject Books</a>
									<?php }?>
