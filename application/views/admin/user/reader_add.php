							...
							<div class="row">
								...
								<div class="col-xl-6 col-md-12" style="margin-left: auto;">
									<div class="row form-group">
										<label class="col-md-12 col-xl-4">Full Name</label>
							...
							<div class="row" style="margin-top: 30px;">
								...
								<div class="col-xl-4 col-md-12">
									...
									<div class="row form-group">
										...
										<div class="col-xl-8 col-md-12">
											<select class="form-control" name="user_type" required>
												...
												<option value="sub_admin" <?php echo (isset($user['user_type']) && $user['user_type'] == 'sub_admin')?'selected':''?>>Sub Admin</option>
									...
									<div class="row form-group">
										...
										<div class="col-md-12 col-xl-8">
											<input type="date" class="form-control" name="dob" required value="<?php echo isset($user['dob'])?$user['dob']:'';?>" placeholder="YYYY-MM-DD" pattern="[0-9]{4}-[0-9]{2}-[0-9]{2}">
											<span class="messages"></span>
										</div>
									</div>
								</div>
