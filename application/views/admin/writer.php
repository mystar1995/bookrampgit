						...
						<div class="card-header">
							<div class="row">
								...
								<div class="col-md-6" style="display: flex;">
									...
									<button class="btn btn-success btn-round waves-effect waves-light status get_user_active" attr_status="true" style="opacity: 0.5">Active</button>
									<button class="btn btn-danger btn-round waves-effect waves-light status get_user_active" attr_status="false" style="opacity: 0.5">InActive</button>
								</div>
							</div>
						</div>
